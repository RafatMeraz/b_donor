    ...
    if (_response.id == ResponseCode.SUCCESSFUL) {
      ...
      for (int i=0; i<_profileModel.activities.length; i++){
        cards.add(Column(
          children: <Widget>[
            ActivityCard(
              id: _profileModel.activities[i].id,
              ...
              descriptions: _profileModel.activities[i].description,
              image: _profileModel.activities[i].image,
              location: _profileModel.activities[i].address,
              reacts: _profileModel.activities[i].id,
              time: _profileModel.activities[i].time,
              state: 1,
            ),
            SizedBox(height: 5),
          ],
